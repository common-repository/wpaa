...
class WPAA_Module_Template extends MDBitz_Plugin {
    ...
    function doPageStyles() {
        if (isset($_GET['page']) && $_GET['page'] == $this->hook) {
            ...
            wp_enqueue_style('wpaa-admin-css', WP_CONTENT_URL . '/plugins/wordpress-advertising-associate/css/admin.css');
        }
    }
    ...
    public function doPage() {
        ...
        ?>
<div class="wrap">
    <h2><img src="<?php echo WP_CONTENT_URL . '/plugins/wordpress-advertising-associate/imgs/WPAA.png'; ?>" alt="WPAA" /> : <?php _e('Template Manager', 'wpaa'); ?><a class="add-new-h2" href="<?php echo admin_url('admin.php?action=add&page=' . $this->hook ); ?>">Add New</a></h2>
