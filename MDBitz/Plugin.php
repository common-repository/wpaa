...
<?php
            ...
            //facebook
            $content .= '<a href="http://www.facebook.com/sharer.php?u=http://mdbitz.com/wpaa/&t=Awesome%20WordPress%20Plugin:%20%20WordPress%Advertising%20Associate" target="_blank"><img src="' . WP_CONTENT_URL . '/plugins/wordpress-advertising-associate/imgs/fb.png" alt="Facebook" /></a>';
            //digg
            $content .= '&nbsp;&nbsp;<a href="http://digg.com/submit?url=http://mdbitz.com/wpaa/" target="_blank"><img src="' . WP_CONTENT_URL . '/plugins/wordpress-advertising-associate/imgs/digg.gif" alt="Digg" /></a>';
            //stubmleupon
            $content .= '&nbsp;&nbsp;<a href="http://www.stumbleupon.com/badge/?url=http://mdbitz.com/wpaa/" target="_blank"><img src="' . WP_CONTENT_URL . '/plugins/wordpress-advertising-associate/imgs/stumbleupon.gif" alt="Stumble Upon" /></a>';
            //delicious
            $content .= '&nbsp;&nbsp;<a href="http://delicious.com/save?v=5&noui&jump=close&url=http://mdbitz.com/wpaa/" target="_blank"><img src="' . WP_CONTENT_URL . '/plugins/wordpress-advertising-associate/imgs/deli.gif" alt="Delicous" /></a>';
            //twitter
            $content .= '&nbsp;&nbsp;<a href="http://twitter.com/home/?status=WordPress+Advertising+Associate+%2C+the+all-in-one+Amazon+Associate+WordPress+Plugin+http://tinyurl.com/wpaaplugin" target="_blank"><img src="' . WP_CONTENT_URL . '/plugins/wordpress-advertising-associate/imgs/twitter.gif" alt="Twitter" /></a>';
            $content .= '</div>';
