...
class WPAA extends MDBitz_Plugin {
    ...
    public function register_amazon_tinymce_plugin($plugin_array) {
        $url = get_bloginfo('wpurl') . '/' . PLUGINDIR . '/wordpress-advertising-associate/tinymce/amazon/editor_plugin.js.php';
    ...
    public function doPage() {
        ...
        ?>
<div class="wrap">
    <h2><img src="<?php echo WP_CONTENT_URL . '/plugins/wordpress-advertising-associate/imgs/WPAA.png'; ?>" alt="WPAA" /> : <?php _e('Settings', 'wpaa'); ?></h2>
